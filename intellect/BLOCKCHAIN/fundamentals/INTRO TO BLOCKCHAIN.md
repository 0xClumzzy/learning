...
5. Finality is probabilistic or exoplicit. In PoW like bitcoin, a transaction gets harder to to reverse as more blocks pile on top(usually 6 confirmations = proactically final). In BTF/PoS chains, finality casn be explicit after a vote/.
6